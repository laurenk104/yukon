...
export default class ClothingCatalog extends BookContainer {
    ...
    constructor(scene, x, y) {
        ...
        tag1_42.angle = 3.0000000000000004;
        page12.add(tag1_42);
        ...
        tag2_34.angle = -3.0000000000000004;
        page12.add(tag2_34);
        ...
        tag1_32.angle = -6.000000000000001;
        page10.add(tag1_32);
        ...
        tag2_24.angle = -3.0000000000000004;
        page9.add(tag2_24);
        ...
        tag2_15.angle = -29.000000000000004;
        page6.add(tag2_15);
        ...
        tag2_1.angle = -29.000000000000004;
        page3.add(tag2_1);
